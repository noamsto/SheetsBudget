...
import com.noam.kotlindev.sheetsbudget.adapters.SortedExpenseAdapter.ExpenseViewHolder
...
class SortedExpenseAdapter(private val context: Context, private val itemSelectedListener: ItemSelectedListener)
